...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (addUser($newUsername, $newPassword, $newPrivilege)) {
                ...
                <p>
                    ...
                    if (isset($_SESSION["privilege"])) {
                        if ($_SESSION["privilege"] < 3) {
                            ?>
                            <input type="radio" name="privilege" value=2>Owner<br>
                        <?php
                        }
                    }
                    ?>
                    <input checked="checked" type="radio" name="privilege" value=3>Pollster<br>
                </p>
