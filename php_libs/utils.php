...
function generateMenu()
{
    ...
    if (isset($_SESSION["privilege"])) {
        if ($_SESSION["privilege"] < 3) {
            echo "
        <li>
            <a href=\"manageProductTypes.php\">Manage products types</a>
        </li>
        <li>
            <a href=\"manageProducts.php\">Manage products</a>
        </li>
        <li>
            <a href=\"manageQuestionnaires.php\">Manage questionnaires</a>
        </li>
        <li>
            <a href=\"browseResults.php\">Browse results</a>
        </li>
";
        }
    }
    ...
    if (isset($_SESSION["privilege"])) {
        echo "
    <li>
        <a href=\"takeSurvey.php\">Take survey</a>
    </li>";
